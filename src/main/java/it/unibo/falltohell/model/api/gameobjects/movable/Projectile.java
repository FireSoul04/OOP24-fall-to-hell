...
public interface Projectile extends Movable {
     ...
     *
     * @param hit {@code true} if the projectile has hit something, {@code false} otherwise
     */
     ...
     * If the other object is solid and the projectile has not already hit, marks this projectile as hit
     *
