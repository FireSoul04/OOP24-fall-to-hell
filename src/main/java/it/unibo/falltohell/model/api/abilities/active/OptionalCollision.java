...
/**
 * Functional interface representing the collision behavior of an active ability.
 * Used to define custom behavior when the ability collides with another {@link GameObject}.
