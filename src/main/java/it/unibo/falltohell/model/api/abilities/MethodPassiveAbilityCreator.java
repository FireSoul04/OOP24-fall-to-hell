...
/**
 * Functional interface representing a factory method used to create {@link MethodPassiveAbility}
...
public interface MethodPassiveAbilityCreator {
     ...
     * <p>
     * @param character the character instance for which the ability should be created
     * @return the {@link MethodPassiveAbility} instance associated with the character
     */
