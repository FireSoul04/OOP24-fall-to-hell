...
public interface AbilityFactory {
     ...
     * @param collider the {@link Collider} used for collision detection of the ability
     * @param velocity the velocity vector ({@link Vector2}) of the ability
     * @param attack a lambda defining the behavior of the attack, with parameters velocity and deltaTime, see {@link ActiveAbilityUpdate}
     * @param collided an optional lambda handling collision events; pass {@link Optional#empty()} for default collision handling
     ...
     * @param lambda the behavior to execute for the passive ability, see {@link PassiveAbilityDo}
     ...
     * <p>
     * @param character the {@link Character} for which to create the method passive ability
