 ...
 * Extends {@link BaseEnemyStatisticsImpl} and implements {@link LongRangeEnemyStatistics}.
 *
 * @author Sara Visani
 */
public class LongRangedEnemyStatisticsImpl extends BaseEnemyStatisticsImpl implements LongRangeEnemyStatistics{
     ...
     * @param dimension the size/dimensions of the enemy as {@link Dimensions}
     ...
     * @param projectileVelocity the velocity of the projectile as a {@link Vector2}
     * @param projectileDimensions the dimensions of the projectile as {@link Dimensions}
     */
