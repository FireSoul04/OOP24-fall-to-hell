 ...
 * @author Sara Visani
 */
public class MethodPassiveAbilityTest2 implements MethodPassiveAbility {
     ...
     *                  with
     */
    public MethodPassiveAbilityTest2(final Character character) {
    ...
    public void update(final double deltaTime) {
        System.out.println("Ability 2 updating for: " + character.getClass().getSimpleName());
    }
     ...
     */
    @Override
    public void onCollision(final GameObject other, final Vector2 position) {
        System.out.println("Ability 2 collision at: " + position);
    }
}